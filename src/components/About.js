	  ...
	  <div className="row hidden-print">
			<div className="col-xs-10 col-xs-offset-1" id="about">
				<div className="page bshadowed layer1 m20" >
					...
					<p>'Polyglots: The Bible in Multiple Tongues' is part of <em>Religious Change, 1450-1700</em>, the Newberry Library's year-long, multidisciplinary project exploring how religion and print challenged authority, upended society, and made the medieval world modern.<br/><br/>This site was built with by <a href="https://www.siteations.com" target="_blank">Siteations Studio</a>.</p>
					<h2 className="underline">ABOUT POLYGLOTS: THE BIBLE IN MULTIPLE TONGUES</h2>
