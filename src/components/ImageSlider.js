...
class ImageSlider extends Component {
  ...
  switchIndex(e){
	...
	render() {
		...
		//'https://s3.us-east-2.amazonaws.com/polyglot-images/'+this.props.images[this.state.active].replace('./resampled','medium')

	return (
		<div>
			<div className="text-center">
				<a href={'https://s3.us-east-2.amazonaws.com/polyglot-images/'+this.props.images[this.state.active].replace('./resampled','medium')} target='_blank'> <img src={'https://s3.us-east-2.amazonaws.com/polyglot-images/'+this.props.images[this.state.active].replace('./','')} style={{maxWidth: '100%', maxHeight: '350px', margin: '2%' , borderRadius: '5px', cursor: 'zoom-in'}}  /> </a>
