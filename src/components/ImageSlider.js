	...
	return (
		<div>
			<div className="text-center">
				<a href={this.props.link} target='_blank'> <img src={this.props.images[this.state.active].replace('./resampled','./thumbnail')} style={{maxWidth: '100%', maxHeight: '350px', margin: '2%' , borderRadius: '5px', cursor: 'zoom-in'}}  /> </a>
        <p className="small"><em>click to open/explore in CARLI digital collections</em></p>
			</div>
