	...
	return (
		<div>
			<div className="text-center">
				<a href={this.props.images[this.state.active].replace('resampled', 'medium')} target='blank'> <img src={this.props.images[this.state.active]} style={{maxWidth: '100%', maxHeight: '350px', margin: '2%' , borderRadius: '5px', cursor: 'zoom-in'}}  /> </a>
