...
export const Footer = function(){
  ...
  return (
      <footer id="footer" className="region region-footer col-xs-10 col-xs-offset-1">
          <div id="block-menu-block-2" className="block block-menu-block footer-nav first odd" role="navigation">
          <div className="inner">
